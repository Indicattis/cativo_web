    ...
    return (
        <section className={`_section relative overflow-hidden `}>
            <div className="relative w-full flex justify-center bg-black overflow-hidden">
                <div className=" max-w-[1080px] flex w-full justify-between py-5  max-lg:flex-col gap-5 border-b border-dark">
            ...
            <GridComponent cols={2} rows={2}>
                <GridElement col={2} row={1}>
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-10 items-center justify-center">
                            ...
                            <motion.div className="w-full flex items-center gap-3 _text px-5  max-md:flex-col max-md:items-start py-3 bg-white rounded-xl">
                                ...
                                <div className="flex flex-col">
                                    <h1 className="text-dark _text font-thin">
                                        Desenvolvido e hospedado por{" "}
                                        <span className="font-normal">
                                            João Pedro Indicatti
                                        </span>
                                    </h1>
                                    <h1 className="text-dark _text _small font-thin">
                ...
                <GridElement col={2} row={1}>
                    <h1 className="absolute top-5 _display_text flex flex-col gap-2 items-center w-full">
                        ...
                        <span className="_text  font-light text-white">
                            Responsividade
                        </span>
                    </h1>
                    <motion.div
