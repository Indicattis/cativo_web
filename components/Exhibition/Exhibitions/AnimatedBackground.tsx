...
export default function AnimatedBackground({
  ...
  return (
    <div className={`flex flex-col justify-center items-center w-full h-full relative bg-gradient-to-tr from-neon_purple to-black overflow-hidden`}>
...
function AnimationElement({
  ...
  return (
      ...
      >
          <motion.div
              className={`bg-gradient-to-tr from-neon_purple to-black w-full h-full shadow-lg shadow-dark rounded-full flex justify-center items-center _text _small text-zinc-400`}
          ></motion.div>
      </motion.div>
  );
}
