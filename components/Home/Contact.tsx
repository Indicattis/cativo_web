...
export default function ContactComponent() {
    return (
        <Layout.Section id="contact" className=" h-screen relative  !z-0">
                ...
                <Layout.Main className="h-full w-full">
                    ...
                    <Layout.Div className="flex-col w-full gap-10">
                        ...
                        <div className="w-full flex items-center justify-center gap-3">
                            ...
                            <div className="bg-contrast_color_2 p-3 rounded-r-2xl rounded-t-2xl">
                        ...
                        <motion.div
                            ...
                            >
                                ...
                                <div className="flex flex-wrap items-center justify-center w-full gap-2">
                                    ...
                                    <Button.Wide rounded="full" variant="black" wide="lg" onClick={() => window.location.href = "mailto:joao.indicatti@outlook.com?subject=Contato"}>
                                        <Button.Text text="Enviar e-mail" />
                                        <Button.Icon icon={<IconMail />} />
                                    </Button.Wide>
                                    <Button.Wide rounded="full" variant="green" wide="lg" onClick={() => window.location.href = "https://wa.me/5554996598024"}>
                                        <Button.Text text="Enviar mensagem" />
                                        <Button.Icon icon={<IconBrandWhatsapp />} />
                                    </Button.Wide>
                                    <Button.Wide rounded="full" variant="blue" wide="lg" onClick={() => window.location.href = "https://www.linkedin.com/in/joão-pedro-indicatti-07975b265/"}>
                                        <Button.Text text="Linkedin" />
                                        <Button.Icon icon={<IconBrandLinkedin />} />
                                    </Button.Wide>
                                    <Button.Wide rounded="full" variant="red" wide="lg" onClick={() => window.location.href = "https://www.instagram.com/indicatti_s/"}>
